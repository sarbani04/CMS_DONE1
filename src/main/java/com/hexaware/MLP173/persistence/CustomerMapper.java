...
import com.hexaware.MLP173.model.CustomerStatus;
...
public class CustomerMapper implements ResultSetMapper<Customer> {
  ...
  public final Customer map(final int idx, final ResultSet rs, final StatementContext ctx) throws SQLException {
       ...
       * @return Customer
       */
    String type = rs.getString("CUS_GENDER");
    CustomerStatus cusStat = CustomerStatus.valueOf(type);
    ...
    rs.getString("CUS_EMAIL"), rs.getString("CUS_MOBILE"), rs.getDate("CUS_DOB"), rs.getString("CUS_ADDRESS"), cusStat);
  }
}
