 ...
 */
  ...
  */
  ...
  private void placeOrder() {
    ...
    orderdetail.setMenuId1(option.nextInt());
    String status1;
    int count=0;
    do{
      ...
      if(status1.equalsIgnoreCase("YES")){
        ...
        orderdetail.setMenuId2(option.nextInt());
      }  
      if(status1.equalsIgnoreCase("YES")){
        System.out.println("Enter Menu Id 3 ");
        orderdetail.setMenuId3(option.nextInt());
        count = count+1;
      }
      else{
        break;
  ...
  private void showCustomerInfo() {
    ...
    System.out.println("----------------------------------------------------"
          + "----------------------------------------------");
    System.out.printf("%5s %15s %25s %20s %20s %30s %20s", "Customer Id", "Customer Name",
        "Customer E-mail", "Customer Mobile", "Customer DOB", "Customer Address", "Gender");
    System.out.println();
    System.out.println("----------------------------------------------------"
          + "----------------------------------------------");
