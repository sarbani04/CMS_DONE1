 ...
 */
  private String cusAddress;
   /**
 * CusGender to store Item Rate.
 */
private CustomerStatus cusGender;
  /**
   * Default Constructor.
   */
  public Customer() {
 ...
 * @param argCusGender to initialize food Rating.
 * used to get details through constructor.
 */
  public Customer(final int argCusId, final String argCusName, final String argCusPassword,
        final String argCusEmail, final String argCusMobile, final Date argCusDob, final String argCusAddress, final CustomerStatus argCusGender) {
    this.cusId = argCusId;
  ...
  @Override
    ...
    if (Objects.equals(cusId, customer.cusId)
        ...
        && Objects.equals(cusGender, customer.cusGender)) {
      return true;
    }
    return false;
  }
  @Override
    ...
    return Objects.hash(cusId, cusName, cusPassword, cusEmail, cusMobile, cusDob, cusAddress, cusGender);
  }
    /**
     * @return this venId
     */
  ...
  public final void setCusAddress(final String argCusAddress) {
   ...
   /**
     ...
     */
    public final CustomerStatus getCusGender() {
      return cusGender;
    }
        /**
         * @param argCusAddress gets the VenAddress.
         */
    public final void setCusGender(final CustomerStatus argCusGender) {
      this.cusGender = argCusGender;
    }
  ...
  */
  ...
  public final String toString() {
    return String.format("%5s %15s %25s %20s %20s %20s %20s %20s", cusId, cusName, cusPassword, cusEmail, cusMobile, cusDob, cusAddress, cusGender);
  }
}
