 ...
 * @param argmenuId1 to initialize Wallet type
 * @param argmenuId2 to initialize Wallet type
 * @param argmenuId3 to initialize Wallet type
 ...
 */
  public OrderDetail(final int argOrdId, final Date argOrdTime, final Double argOrdAmount,
        ...
        final int argCusId, final int argFoodId, final int argVenId, final String argWalType, final String argOrdComments, final int argmenuId1,
        final int argmenuId2, final int argmenuId3) {
    this.ordId = argOrdId;
  ...
  /**
    ...
    public final int getmenuId1() {
      ...
      /**
        * @param argMenuId1 gets the walleType.
        */
    ...
    public final int getmenuId2() {
      ...
      /**
        * @param argMenuId2 gets the walleType.
        */
    ...
    public final int getmenuId3() {
      ...
      /**
        * @param argMenuId3 gets the walleType.
        */
  ...
  public final String toString() {
    return String.format("%-15s %-15s %-15s %-18s %-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s", ordId, ordTime, ordAmount, ordStatus, qtyOrder,
        cusId, foodId, venId, walType, menuId1, menuId2, menuId3);
  }
}
